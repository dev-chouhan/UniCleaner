...
def realTime():
    ...
    ACTIONS = {
        ...
        2 : "Deleted",
        3 : "Updated",
        4 : "Rename from something",
        5 : "Rename to something"
    }

    FILE_LIST_DIRECTORY = 0X0001 # predefined code for C directory
    path_to_watch = "C:\\"
    ...
    while 1:
        ...
        for action, file in results:
            ...
            # For just be able to check all other files than this
            ...
            # To see all the changing files
            try:print(paths[0], ACTIONS.get(action, "Unknown"))
            except:pass

            # try:virusEngine.folderScan(paths[0])
            # except:pass
            # paths.clear()
